...
export const services: Service[] = [
  ...
  },
  {
    ...
    icon: "🚛",
    tagline: "Chicago to Indiana, Wisconsin, and beyond.",
    description:
      "Crossing state lines? We handle long-distance moves with the same care and precision as our local moves — full inventory tracking, protected transport, and on-schedule delivery.",
    features: [
      "Illinois to Indiana & Wisconsin",
    ...
    details: [
      "Placid Transit serves the tri-state area including Illinois, Indiana, and Wisconsin. If you're relocating across state borders, we've got the logistics handled.",
      "Every long-distance move includes a detailed inventory list, furniture protection, and a confirmed delivery window — so you're never left wondering where your belongings are.",
